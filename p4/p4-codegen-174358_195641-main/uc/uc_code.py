...
class CodeGenerator(NodeVisitor):
    ...
    def visit_If(self, node: If):
        ...
        iftrue = BasicBlock(f'then.{if_id}')
        iffalse = BasicBlock(f'else.{if_id}')
        end = BasicBlock(f'end.{if_id}')
    ...
    def visit_For(self, node: For):
        ...
        inc.predecessors = self.current_block
    ...
    def visit_Assert(self, node: Assert):
        ...
        blk_true.predecessors = blk
        blk_false.predecessors = blk
